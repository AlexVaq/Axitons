...
void	propGpu	(const void * __restrict__ field, void * __restrict__ dev, void * __restrict__ misc, const double R, const double dz, const double c, const double d, const double ood2,
